...
use super::fdt::core::pci::GuestPciHost;
#[cfg(all(test, not(target_arch = "aarch64")))]
use crate::boot::fdt::test_core::pci::GuestPciHost;
use crate::{AxVmError, AxVmResult, ConfiguredPciEndpoint, config::AxVMConfig};
...
mod tests {
    ...
    use axdevice_base::{BusResponse, DeviceAccess, DeviceResult, GuestPhysAddr};
