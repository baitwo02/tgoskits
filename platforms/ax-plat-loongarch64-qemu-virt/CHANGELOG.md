...
## [0.5.12](https://github.com/rcore-os/tgoskits/compare/ax-plat-loongarch64-qemu-virt-v0.5.11...ax-plat-loongarch64-qemu-virt-v0.5.12) - 2026-06-06

### Other

- updated the following local packages: ax-cpu, ax-kspin, ax-driver, ax-plat, axklib
