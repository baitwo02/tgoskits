...
## [1.1.1](https://github.com/rcore-os/tgoskits/compare/arceos-rust-interface-v1.1.0...arceos-rust-interface-v1.1.1) - 2026-06-06

### Other

- updated the following local packages: ax-kspin, ax-io, ax-driver, ax-hal, ax-runtime, ax-feat, ax-posix-api, ax-api
